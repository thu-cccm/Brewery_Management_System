...
public interface BrewStatisticsMapper 
{
    ...
    List<Map<String, Object>> selectQualityStability(@Param("categoryCode") String categoryCode);

    List<Map<String, Object>> selectProductionEfficiency();

    List<Map<String, Object>> selectProductionProgress();
}
