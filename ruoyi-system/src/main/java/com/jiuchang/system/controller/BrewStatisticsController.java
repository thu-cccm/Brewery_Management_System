...
public class BrewStatisticsController extends BaseController
{
    ...
    public AjaxResult getProductionStats()
    {
        return success(brewStatisticsService.getProductionStats());
    }

    @GetMapping("/yield")
    public AjaxResult getYieldStats()
    {
        return success(brewStatisticsService.getYieldStats());
    }
    ...
    @GetMapping("/qualityStability")
    public AjaxResult getQualityStability(@RequestParam(value = "categoryCode", required = false) String categoryCode)
    {
        return success(brewStatisticsService.getQualityStability(categoryCode));
    }

    @GetMapping("/efficiency")
    public AjaxResult getProductionEfficiency()
    {
        return success(brewStatisticsService.getProductionEfficiency());
    }

    @GetMapping("/progress")
    public AjaxResult getProductionProgress()
    {
        return success(brewStatisticsService.getProductionProgress());
    }
}
