<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位编码" prop="postCode" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="岗位名称" prop="postName" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="岗位排序" prop="postSort" width="100" />
